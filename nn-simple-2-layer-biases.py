...
for i in range(1000):
    layer_0 = X
    layer_1 = tanh(np.dot(layer_0, weights_0) + biases_0)
    layer_2 = tanh(np.dot(layer_1, weights_1) + biases_1)
    ...
    biases_1 -= 0.1 * np.sum(layer_2_delta)
    biases_0 -= 0.1 * np.sum(layer_1_delta)
